...
import { FiBookOpen, FiMessageCircle, FiRepeat, FiUserCheck, FiCpu, FiInfo, FiChevronRight } from 'react-icons/fi';
  ...
  return (
    <div className="p-4 flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-2 gap-4 max-w-4xl">
        {/* Text Summarization */}
        <div
          className="bg-blue-50 p-3 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out">
          <div className="flex items-center">
            <FiBookOpen className="text-blue-600 text-xl mr-2" />
            <h3 className="text-sm font-semibold text-gray-800">Text Summarization</h3>
          </div>
          <p className="text-gray-600 text-xs mt-1">Summarize long articles, research papers, or documents into concise overviews.</p>
          <button className="mt-2 text-blue-600 text-sm flex items-center font-semibold hover:underline"   
                  onClick={() => onCardClick('Could you please summarize the text for me? Let me know if you need more context or specific sections to focus on')}>
        ...
        <div
          className="bg-green-50 p-3 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out"        >
          <div className="flex items-center">
        ...
        <div
          className="bg-yellow-50 p-3 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out" >
          <div className="flex items-center">
            <FiRepeat className="text-yellow-600 text-xl mr-2" />
            <h3 className="text-sm font-semibold text-gray-800">Language Translations</h3>
          </div>
          <p className="text-gray-600 text-xs mt-1">Translate text between languages to facilitate communication across language barriers.</p>
          <button className="mt-2 text-yellow-600 text-sm flex items-center font-semibold hover:underline"
                  onClick={() => onCardClick('I need assistance translating a text into another language. Could you please assist me? Let me know if you need the target language or any specific context for an accurate translation.')}
          >
            Try it now <FiChevronRight className="ml-1" />
          </button>
        </div>
        ...
        <div
          className="bg-red-50 p-3 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 ease-in-out">
          <div className="flex items-center">
            <FiCpu className="text-red-600 text-xl mr-2" />
            <h3 className="text-sm font-semibold text-gray-800">Engaging in Technical Dialogues</h3>
          </div>
          <p className="text-gray-600 text-xs mt-1">Ask specialized or technical questions related to research, AI, or other fields.</p>
          <button className="mt-2 text-red-600 text-sm flex items-center font-semibold hover:underline"
                  onClick={() => onCardClick('I have a technical question and would appreciate your help. Please ask for any additional details or clarifications you need before providing an answer.')}
          >
            Try it now <FiChevronRight className="ml-1" />
          </button>
        </div>
