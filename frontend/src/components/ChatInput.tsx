...
const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage, onFileChange, onDownloadChat }) => {
  ...
  return (
    <div className="p-0 bg-grey-500">
      ...
      Disclaimer: You are responsible for ensuring the accuracy, completeness, and relevance of any output generated by this tool and how the generated output is used. You should always independently understand and verify the content generated is accurate and suitable for your use. Please make any necessary edits before sharing the output from this tool.
