         ...
         <h1 className="text-3xl font-bold mb-6 text-gray-800">Overview of the NIAMS Artificial Intelligence (AI) Chat</h1>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <strong>Please note: </strong> Responses from this tool may be inaccurate (hallucinations), outdated, incomplete, or not aligned to your specific needs. Each user should always independently understand and verify that the content generated is accurate in your specific context and suitable for your use. Each user is recommended to review other sources of information to verify accuracy of the generated content. Please make any necessary edits before sharing the output from this tool.
              </p>
